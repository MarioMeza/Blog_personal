# Generated by Django 3.0.8 on 2020-07-24 04:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_modificacion', models.DateField(auto_now=True, verbose_name='Fecha de Modificación')),
                ('fecha_eliminacion', models.DateField(auto_now=True, verbose_name='Fecha de Eliminación')),
                ('nombre', models.CharField(max_length=100, unique=True, verbose_name='Nombre de la portada')),
                ('imagen_referencial', models.ImageField(upload_to='portadas/', verbose_name='Imagen Referencial')),
            ],
            options={
                'abstract': False,
            },
