...
class Portada(ModeloBase):
    nombre = models.CharField('Nombre de la portada', max_length = 100, unique = True)
    imagen_referencial = models.ImageField('Imagen Referencial',upload_to = 'portadas/')
